...
### 1. Create Data & Results Folders

The scripts expect the following folders to exist:
...
- `--output` (optional): path where the raw CSV will be written  
...
- `--input` (optional): path to the raw dataset  
  - Default: `data/raw/iris.csv`
- `--output` (optional): path for the cleaned dataset  
...
- `--input` (optional): path to the cleaned dataset  
  - Default: `data/processed/iris_clean.csv`
- `--output-dir` (optional): directory to save figures  
...
- `--input` (optional): path to the cleaned dataset  
  - Default: `data/processed/iris_clean.csv`
- `--output-dir` (optional): directory to save metrics and artifacts  
